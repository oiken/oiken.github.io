[论坛](https://forum.freecodecamp.org/c/chinese/533) [捐款](https://www.freecodecamp.org/chinese/donate)
...
中，我们首先执行 `a * a / b`，由于是从左到右的，我们可以拆分为 `a * a` 与其结果
									`/b`： `2 * 2 = 4`， `4 / 4 = 1`。
